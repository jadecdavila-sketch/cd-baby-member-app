  ...
  const actions = [
    {
      ...
      description: 'Create a personalized music link to share your latest release across all platforms.',
    ...
    },
    {
      ...
      description: 'Launch targeted ads to promote your music where it\'s gaining the most traction.',
    ...
    },
    {
      ...
      icon: BookOpen,
      title: 'Learn & Grow',
      description: 'Access guides on how to maximize your streams, engagement, and tour planning.',
          ...
          return (
            ...
            >
              <CardContent className="p-6">
                {/* Icon */}
                <div className={`mb-4 inline-flex rounded-lg p-3 ${action.bgColor}`}>
                  <Icon
                    className="h-6 w-6"
