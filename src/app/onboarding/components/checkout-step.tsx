...
export function CheckoutStep({ total, onSubmit }: CheckoutStepProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Apple Pay, Google Pay & PayPal Buttons */}
      <div className="grid grid-cols-3 gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-1 rounded-[3px] py-4 font-medium transition-all hover:opacity-90"
          style={{ backgroundColor: '#000000', color: '#ffffff' }}
        >
        ...
        >
          <svg viewBox="0 0 24 24" className="h-5 w-5">
            <path fill="#00A1E4" d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944.901C5.026.382 5.474 0 5.998 0h7.46c2.57 0 4.578.543 5.69 1.81 1.01 1.15 1.304 2.42 1.012 4.287-.023.143-.047.288-.077.437-.983 5.05-4.349 6.797-8.647 6.797H9.2c-.535 0-.98.38-1.063.9l-.907 5.75a.642.642 0 0 1-.634.536l-.52-.18z"/>
            <path fill="#003087" d="M23.048 7.667c-.028.179-.06.362-.096.55-1.237 6.351-5.469 8.545-10.874 8.545H9.326c-.661 0-1.218.48-1.321 1.132l-1.425 9.05a.535.535 0 0 0 .528.619h3.707c.576 0 1.066-.42 1.155-.99l.048-.248.914-5.8.059-.32c.089-.57.579-.99 1.155-.99h.728c4.715 0 8.405-1.915 9.485-7.454.45-2.315.217-4.248-.975-5.606a4.645 4.645 0 0 0-1.336-.938"/>
          </svg>
          <span>PayPal</span>
        </button>
      </div>
